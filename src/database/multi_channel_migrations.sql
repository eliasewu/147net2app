...
-- ----- 30. Extended translation types for number stripping/prefix & OTP extraction
-- The translations table already exists with translation_type VARCHAR(50).
-- No schema change needed — we simply add support for new type values:
...
--   content_otp_extract — extract OTP via regex, replace in template
-- ============================================================
