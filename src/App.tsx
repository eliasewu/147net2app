...
import { RatePlans } from './pages/Rates/RatePlans';
...
import { NumberBlacklistPage } from './pages/Translations/NumberBlacklist';
import { KeywordFilterPage } from './pages/Translations/KeywordFilter';
...
import { ApiDocs } from './pages/System/ApiDocs';
import {
  ...
  return (
    <Routes>
      ...
      <Route path="/" element={<ProtectedRoute><MainLayout /></ProtectedRoute>}>
        ...
        <Route path="clients/rates" element={<Navigate to="/rates/plans" replace />} />
        <Route path="suppliers" element={<SuppliersList />} />
        <Route path="suppliers/add" element={<AddSupplier />} />
        <Route path="suppliers/:id" element={<SupplierDetail />} />
        <Route path="suppliers/:id/edit" element={<AddSupplier />} />
        <Route path="suppliers/rates" element={<Navigate to="/rates/plans" replace />} />
        ...
        <Route path="rates" element={<ErrorBoundary title="Rate Management couldn't load"><RateManagement /></ErrorBoundary>} />
        <Route path="rates/plans" element={<ErrorBoundary title="Rate Plans couldn't load"><RatePlans /></ErrorBoundary>} />
        <Route path="rates/upload" element={<BulkUpload />} />
        <Route path="rates/mccmnc" element={<ErrorBoundary title="MCC/MNC Database couldn't load"><MCCMNCDatabase /></ErrorBoundary>} />
        ...
        <Route path="translations/blacklist" element={<NumberBlacklistPage />} />
        <Route path="translations/keywords" element={<KeywordFilterPage />} />
        ...
        <Route path="system/api-docs" element={<ErrorBoundary title="API Documentation couldn't load"><ApiDocs /></ErrorBoundary>} />
      </Route>
